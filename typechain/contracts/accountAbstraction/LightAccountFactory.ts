...
export interface LightAccountFactoryInterface extends utils.Interface {
  functions: {
...
export interface LightAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LightAccountFactoryInterface;
